  ...
  return (
    <>
      ...
      <div className="flex items-center">
        ...
        <Link to="/music" className="pl-2 font-semibold hidden md:block">
          Music
        </Link>
        <div className="pl-2 font-semibold hidden md:block">Podcast</div>
        <div className="pl-2 font-semibold hidden md:block">Go Pro</div>
      </div>
